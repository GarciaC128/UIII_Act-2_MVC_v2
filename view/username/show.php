...
<table class="table container-fluid">
    ...
    <tbody>
        <tr>
            <td scope="col"><?= $date["id_platillo"]?></td>
            <td scope="col"><?= $date["platillo"]?></td>
            <td scope="col"><?= $date["descripcion"]?></td>
            <td scope="col"><?= $date["precio"]?></td>
            <td scope="col"><?= $date["ingredientes"]?></td>
            <td scope="col"><?= $date["categoria"]?></td>
            <td scope="col"><?= $date["calorias"]?></td>
            <td scope="col"><img src="data:image/jpeg;base64,<?=base64_encode($date["imagen"]) ?>" alt="imagen" width="100" height="100" /></td>
        </tr>
    </tbody>
</table>
